...
def get_top_post(output, label, test_id, top_n = 500):
    ...
    pickle.dump(top_n_id_dict, open("/kaggle/working/EANN-KDD18/data/weibo/top_n_id.pickle", "wb"))
...
def load_data(args):
    ...
    #print(train[4][0])
    word_vector_path = '/kaggle/working/EANN-KDD18/data/weibo/word_embedding.pickle'
